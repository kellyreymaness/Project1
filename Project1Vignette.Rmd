...
ggplot(franData, aes(x = data.losses, y = data.penaltyMinutes)) + geom_jitter(aes(color=franAge)) + ggtitle("Scatterplot of Total Losses vs. Penalty Minutes") + ylab("Total Penalty Minutes") + xlab("Total Losses")
```
